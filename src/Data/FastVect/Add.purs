...
class AddSingle (augend :: Symbol) (addend :: Symbol) (carry :: Symbol) (sum :: Symbol) 
    ...
    , augend sum -> carry addend
    , addend sum -> carry augend 
...
else instance (Fail (Text "I couldn't find a solution for the terms you are giving me. You are trying to add numbers that don't add up like 2 + 4 = 1 3. Verify that your augend, addend, carry and sum are correct.")) 
    => AddSingle u a c s 
...
class AddHelper1 (augendHead :: Symbol) (augendTail :: Symbol) (addendHead :: Symbol) (addendTail :: Symbol) (carry :: Symbol) (sum :: Symbol)
    | augendHead augendTail addendHead addendTail -> carry sum
    , augendHead augendTail sum -> addendHead addendTail carry 
    , addendHead addendTail sum -> augendHead augendTail carry
...
class AddHelper (augendHead :: Symbol) (augendTail :: Symbol) (addendHead :: Symbol) (addendTail :: Symbol) (carry :: Symbol) (sum :: Symbol) 
    | augendHead augendTail addendHead addendTail -> carry sum 
    , augendHead augendTail sum -> carry addendHead addendTail
...
class Add (augend :: Symbol) (addend :: Symbol) (carry :: Symbol) (sum :: Symbol) | augend addend -> carry sum, augend sum -> carry addend
...
class Add2Helper (augendHead :: Symbol) (augendTail :: Symbol) (addendHead :: Symbol) (addendTail :: Symbol) (carry :: Symbol) (sum :: Symbol) 
    | augendHead augendTail addendHead addendTail -> carry sum 
    , augendHead augendTail sum -> carry addendHead addendTail
    , addendHead addendTail sum -> carry augendHead augendTail 
...
, Cons intermediateSum tailSum sum 
) =>  Add2Helper augendHead augendTail addendHead addendTail carry sum 

class Add2 (augend :: Symbol) (addend :: Symbol) (carry :: Symbol) (sum :: Symbol) 
    | augend addend -> carry sum
    , augend sum -> carry addend
    , addend sum -> carry augend 
...
, Cons addendHead addendTail addend 
, Add2Helper augendHead augendTail addendHead addendTai carry sum 
) => Add2 augend addend carry sum 

term :: forall sym. Proxy sym
term = Proxy 

sum :: forall augend addend carry sum result. 
    Add2 augend addend carry sum => Cons carry sum result => Proxy augend -> Proxy addend -> Proxy result 
sum _ _ = Proxy 
